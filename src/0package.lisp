...
(in-package :cl-user)
(uiop:define-package :dsama
    (:mix :numcl :serializable-object :trainable-object :alexandria
          :arrow-macros :trivia :closer-mop :iterate)
  (:use   :remlic :cl-random-forest :cl-json)
  (:export
   #:dump-tsv
   #:list-actions
   #:train-model
